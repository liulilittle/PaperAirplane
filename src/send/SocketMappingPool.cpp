...
void SocketMappingPool::Enter()
{
	EnterCriticalSection(&m_cs);
}

void SocketMappingPool::Leave()
{
...
void SocketBinderContext::LeaveLook()
{
	if (this->Look != NULL)
	{
...
void SocketBinderContext::Finalize()
{
	if (this->Look != NULL)
	{
